...
void CTwBar::UpdateColors()
{
    ...
    m_ColLabelText = lightText ? COLOR32_BLACK : COLOR32_WHITE;
    ...
    m_ColEditText = lightText ? COLOR32_BLACK : COLOR32_WHITE;
    ...
    ColorHLSToRGBf(h, l, s, &r, &g, &b);
    m_ColBtn = Color32FromARGBf(a, r, g, b);
    ColorHLSToRGBf(h, l, s, &r, &g, &b);
    m_ColHighBtn = Color32FromARGBf(a, r, g, b);
    ColorHLSToRGBf(h, l, s, &r, &g, &b);
    m_ColFold = Color32FromARGBf(a, r, g, b);
    ColorHLSToRGBf(h, l, s, &r, &g, &b);
    m_ColHighFold = Color32FromARGBf(a, r, g, b);
